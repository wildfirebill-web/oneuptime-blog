# Using the Calico BlockAffinity Resource in Production Clusters

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes

Description: Practical patterns and real-world examples for using Calico BlockAffinity resources effectively in production Kubernetes environments.
...
The BlockAffinity resource works together with other Calico resources. Here is how to verify the combined effect:
...
Set up ongoing monitoring for your BlockAffinity resources:
