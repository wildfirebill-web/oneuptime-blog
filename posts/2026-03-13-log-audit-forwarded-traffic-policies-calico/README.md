# How to Log and Audit Forwarded Traffic Policies for Calico Hosts

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Log Audit Calico forwarded traffic policies on hosts for log audit traffic control at the node level.
...
This guide covers how to log audit Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: log-audit-forwarded-traffic
spec:
  order: 100
