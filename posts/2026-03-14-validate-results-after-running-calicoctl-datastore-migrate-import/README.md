# Validating Results After Running calicoctl datastore migrate import
...
After running `calicoctl datastore migrate import`, thorough validation ensures that your Calico data is intact and the migration step completed correctly. Skipping validation risks discovering data loss or corruption only after the migration is finalized.
