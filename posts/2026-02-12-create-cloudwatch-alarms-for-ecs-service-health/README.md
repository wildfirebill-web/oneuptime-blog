...
For alarms on other services in your stack, check out our posts on [CloudWatch alarms for Lambda error rates](https://oneuptime.com/blog/post/2026-02-12-create-cloudwatch-alarms-for-lambda-error-rates/view) and [CloudWatch alarms for SQS queue backlog](https://oneuptime.com/blog/post/2026-02-12-create-cloudwatch-alarms-for-sqs-queue-backlog/view). For tracing ECS services, see [using X-Ray with ECS sidecar containers](https://oneuptime.com/blog/post/2026-02-12-use-x-ray-with-ecs-sidecar-container/view).
