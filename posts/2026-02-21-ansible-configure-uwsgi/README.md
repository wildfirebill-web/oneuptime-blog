# How to Use Ansible to Configure uWSGI Application Server
...
uWSGI is a high-performance WSGI application server on remote servers. This guide provides practical Ansible playbooks for this common automation task.
...
```yaml
---
- name: How to Use Ansible to Configure uWSGI Application Server
  hosts: app_servers
  become: true
