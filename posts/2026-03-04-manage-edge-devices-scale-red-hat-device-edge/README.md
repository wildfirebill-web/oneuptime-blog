# How to Manage Edge Devices at Scale Using Red Hat Device Edge

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: RHEL, Device Edge, Fleet Management, IoT

Description: Manage edge devices at scale using Red Hat Device Edge.

---

## Overview

Manage edge devices at scale using Red Hat Device Edge. RHEL for Edge provides an immutable, atomic operating system designed for edge computing, IoT, and remote deployments.
...
You have learned how to manage edge devices at scale using red hat device edge. RHEL for Edge with rpm-ostree and MicroShift provides a robust platform for running workloads in remote and resource-constrained environments.
