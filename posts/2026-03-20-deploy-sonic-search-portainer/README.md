...
Description: Deploy Sonic lightweight and fast search backend using Portainer as a Elasticsearch alternative.

## Introduction

Deploy Sonic lightweight and fast search backend using Portainer as a Elasticsearch alternative. Portainer's stack management capabilities make deploying and managing Sonic Search straightforward for development and production environments.
...
# View startup logs
docker logs sonic-search --tail 50
```
...
#!/bin/bash
# backup.sh
BACKUP_DIR="/backups/sonic-search"
