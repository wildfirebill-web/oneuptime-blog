# How to Use Ansible to Manage pyenv on Remote Hosts
...
pyenv lets you install and switch between multiple Python versions on remote servers. This guide provides practical Ansible playbooks for this common automation task.
...
```yaml
---
- name: How to Use Ansible to Manage pyenv on Remote Hosts
  hosts: app_servers
  become: true
