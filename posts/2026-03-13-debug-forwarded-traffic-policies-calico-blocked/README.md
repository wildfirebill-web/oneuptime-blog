# How to Debug Forwarded Traffic Policies for Calico Hosts

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Debug Calico forwarded traffic policies on hosts for debug traffic control at the node level.
...
This guide covers how to debug Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
