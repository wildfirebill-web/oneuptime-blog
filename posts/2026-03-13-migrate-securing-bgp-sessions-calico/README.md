# How to Migrate to Secure BGP Sessions in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, BGP, Security, Network Policy

Description: Migrate secure BGP sessions in Calico to prevent route injection and unauthorized BGP peering.
...
This guide covers migrate BGP sessions in Calico to prevent unauthorized route injection and BGP hijacking.
