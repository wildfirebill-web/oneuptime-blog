# How to Configure IPv6 Addresses on MikroTik
...
Assign static and SLAAC IPv6 addresses to MikroTik RouterOS interfaces using Winbox, WebFig, or CLI commands.
...
How to Configure IPv6 Addresses on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
