# How to Configure IPv6 ND (Neighbor Discovery) on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, IPv6, Neighbor Discovery, NDP, RouterOS

Description: Configure IPv6 Neighbor Discovery settings on MikroTik RouterOS including Router Advertisements and neighbor detection.

## Overview

Configure IPv6 Neighbor Discovery settings on MikroTik RouterOS including Router Advertisements and neighbor detection.
...
How to Configure IPv6 ND (Neighbor Discovery) on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
