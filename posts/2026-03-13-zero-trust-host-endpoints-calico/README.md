# Zero Trust Host Protection with Calico Host Endpoints

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Endpoint, Security

Description: Implement zero trust host protection using Calico host endpoints and GlobalNetworkPolicy.
...
This guide covers how to zero trust Host Endpoints effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: zero-trust-host-endpoints
spec:
  order: 100
