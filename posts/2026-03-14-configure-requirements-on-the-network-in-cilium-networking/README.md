# Configuring Network Requirements for Cilium
...
Apply the following Helm values to configure network requirements for cilium:
...
# Test workload to verify network requirements for cilium configuration
apiVersion: apps/v1
kind: Deployment
metadata:
  name: config-test
