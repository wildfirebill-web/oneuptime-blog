# Common Mistakes to Avoid with Calico NodePort Traffic Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, NodePort, Security

Description: Avoid Mistakes Calico NodePort traffic policies to secure Kubernetes NodePort service access.
