# How to Deploy Containerized Workloads at the Edge Using MicroShift on RHEL 9
...
Deploy containerized workloads at the edge using MicroShift on RHEL 9. RHEL for Edge provides an immutable, atomic operating system designed for edge computing, IoT, and remote deployments.
...
You have learned how to deploy containerized workloads at the edge using microshift. RHEL for Edge with rpm-ostree and MicroShift provides a robust platform for running workloads in remote and resource-constrained environments.
