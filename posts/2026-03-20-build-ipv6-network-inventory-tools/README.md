...
Tags: IPv6, Inventory, Python, NAPALM, Network Automation, Asset Management

Description: Build automated IPv6 network inventory tools that discover and catalog all IPv6 addresses, prefixes, and assignments across your infrastructure.

## Introduction

Build automated IPv6 network inventory tools that discover and catalog all IPv6 addresses, prefixes, and assignments across your infrastructure. This guide covers the essential configuration, code patterns, and verification steps.
...
```yaml
# Configuration example for Build IPv6 Network Inventory Tools
ipv6:
  enabled: true
  networks:
    - prefix: "2001:db8::/32"
