# How to Configure IPv6 VPN (OpenVPN, IPsec) on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, VPN, OpenVPN, IPsec

Description: Configure OpenVPN and IPsec on pfSense to carry IPv6 traffic through VPN tunnels for secure connectivity.

## Overview

Configure OpenVPN and IPsec on pfSense to carry IPv6 traffic through VPN tunnels for secure connectivity.
...
How to Configure IPv6 VPN (OpenVPN, IPsec) on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
