# Troubleshooting Implementation Modes in Cilium Networking

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Cilium, Kubernetes, Networking

Description: Diagnose and resolve common issues with Cilium networking implementation modes including VXLAN overlay, Geneve overlay, and native routing using systematic debugging techniques and Cilium...

---

## Introduction

Troubleshooting implementation modes in cilium networking requires understanding how Cilium implements this feature and where failures can occur in the data path. Cilium supports multiple networking implementation modes: VXLAN overlay (default), Geneve overlay, and native/direct routing. Each mode has different requirements and trade-offs. VXLAN and Geneve create overlay networks that encapsulate pod traffic between nodes. Native routing uses the existing network infrastructure to route pod traffic directly.
...
Examine the Cilium data path for issues related to implementation modes in cilium networking:
