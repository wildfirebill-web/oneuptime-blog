# Monitoring for CIDRNotAvailable Errors in Calico and kubeadm

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Troubleshooting, Monitoring

Description: Set up alerting and observability to detect CIDRNotAvailable errors early in Kubernetes clusters running Calico and kubeadm.
...
Detecting CIDRNotAvailable errors before they impact users requires proper monitoring and alerting. This guide shows you how to set up observability for the Calico components relevant to this error class.

Early detection dramatically reduces mean time to resolution (MTTR). A well-configured monitoring stack can alert you to conditions that lead to CIDRNotAvailable errors before they cause pod connectivity failures.
...
Create PrometheusRule resources for CIDRNotAvailable-related conditions:
...
Monitoring for CIDRNotAvailable errors requires a combination of Prometheus metrics from Calico components and log-based alerting. Set conservative alert thresholds initially and tune them based on your cluster's normal behavior patterns.
