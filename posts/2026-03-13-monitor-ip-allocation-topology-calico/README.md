# How to Monitor IP Address Allocation by Topology in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Topology, Networking

Description: Monitor topology-aware IPAM allocation patterns in Calico to detect topology zone imbalances.
