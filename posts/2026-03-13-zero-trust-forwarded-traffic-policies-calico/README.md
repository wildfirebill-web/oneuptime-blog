# Zero Trust Forwarded Traffic with Calico Host Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Zero Trust Calico forwarded traffic policies on hosts for zero trust traffic control at the node level.
...
metadata:
  name: zero-trust-forwarded-traffic
spec:
  order: 100
