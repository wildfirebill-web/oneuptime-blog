# How to Configure Dual-Stack with Netplan

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Netplan, Dual-Stack, IPv6, IPv4, Ubuntu

Description: Configure both IPv4 and IPv6 simultaneously on Ubuntu/Debian interfaces using Netplan for dual-stack operation.

## Overview

Configure both IPv4 and IPv6 simultaneously on Ubuntu/Debian interfaces using Netplan for dual-stack operation.
