# How to Create Docker Volumes with OpenTofu

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OpenTofu, Docker, Containers, Infrastructure as Code, DevOps

Description: Learn how to create docker volumes with OpenTofu using the Docker provider for local and remote container management.
