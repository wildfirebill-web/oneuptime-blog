# How to Use XDP for IPv6 Packet Filtering

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: eBPF, XDP, IPv6, Filtering, Linux Kernel

Description: Write XDP programs that filter IPv6 packets at line rate using source/destination address matching and extension header parsing.

## Overview

Write XDP programs that filter IPv6 packets at line rate using source/destination address matching and extension header parsing.
...
How to Use XDP for IPv6 Packet Filtering requires understanding IPv6 header structure in C, using XDP or TC hooks for packet interception, and leveraging BPF maps to store IPv6 address state. Always validate packet bounds before accessing headers to avoid eBPF verifier rejections.
