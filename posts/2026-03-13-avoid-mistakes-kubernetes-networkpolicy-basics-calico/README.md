# Common Mistakes to Avoid with Kubernetes NetworkPolicy Basics in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Basics, Security

Description: Avoid Mistakes Kubernetes NetworkPolicy basics using Calico as the network policy enforcement engine.
