# How to Log IPv6 Addresses in Authentication Audit Trails

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Authentication, IPv6, Logging, Audit, Compliance

Description: Capture and store IPv6 client addresses in authentication audit logs for security compliance and forensic investigations.

## Overview

Capture and store IPv6 client addresses in authentication audit logs for security compliance and forensic investigations.
...
How to Log IPv6 Addresses in Authentication Audit Trails requires understanding IPv6 address formats, normalizing IPv4-mapped addresses, and applying security policies at the /64 subnet level for IPv6 since individual users may have trillions of addresses within their prefix.
