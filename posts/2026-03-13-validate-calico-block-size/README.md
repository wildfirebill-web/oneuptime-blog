# How to Validate Changing Calico Block Size

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Block Size, Networking

Description: Validate that Calico has applied new block size settings and is allocating IPs from correctly-sized blocks.
...
How to Validate Changing Calico Block Size in Calico requires careful planning and validation. Use the steps above to ensure your configuration meets your cluster's IP addressing requirements.
