# How to Test Crypto Authentication for Calico Node Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Encryption, WireGuard, Node Security

Description: Test WireGuard-based crypto authentication for Calico node traffic to secure inter-node communication.
...
This guide covers test crypto authentication for Calico node traffic, including both data plane and control plane encryption.
