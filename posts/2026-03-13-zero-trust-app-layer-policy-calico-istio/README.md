# Zero Trust Application-Layer Security with Calico and Istio

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Istio, Application Layer, Security

Description: Zero Trust Calico application-layer network policies using Istio integration for HTTP method and path-based access control.
...
This guide covers zero trust App-Layer Policy using Calico and Istio together.
...
kind: NetworkPolicy
metadata:
  name: zero-trust-app-layer-policy
