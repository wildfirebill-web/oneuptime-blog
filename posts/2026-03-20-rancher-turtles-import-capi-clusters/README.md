# How to Import CAPI Clusters into Rancher

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Rancher Turtles, CAPI, Kubernetes, Rancher, Import

Description: Learn how to import existing CAPI-provisioned clusters into Rancher for unified management and monitoring.

## Introduction

How to Import CAPI Clusters into Rancher is an important aspect of managing Kubernetes clusters with Rancher Turtles and Cluster API. This guide provides a comprehensive walkthrough with practical examples and best practices.
...
Rancher Turtles integrates Cluster API (CAPI) with Rancher to provide a unified, declarative approach to Kubernetes cluster lifecycle management. This guide walks through the specifics of How to Import CAPI Clusters into Rancher.
...
```yaml
# Example CAPI configuration for How to Import CAPI Clusters into Rancher
