# Common Mistakes to Avoid with Calico Host Endpoint Policies
...
This guide covers how to avoid mistakes Host Endpoints effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: avoid-mistakes-host-endpoints
spec:
  order: 100
