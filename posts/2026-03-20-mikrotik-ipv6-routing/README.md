# How to Configure IPv6 Routing on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, IPv6, Routing, Static Routes, RouterOS

Description: Configure IPv6 static routes and enable IPv6 forwarding on MikroTik RouterOS for proper packet routing.

## Overview

Configure IPv6 static routes and enable IPv6 forwarding on MikroTik RouterOS for proper packet routing.
...
How to Configure IPv6 Routing on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
