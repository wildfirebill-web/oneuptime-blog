...
Configure Cilium's eBPF-based load balancer for Kubernetes services with IPv6 ClusterIPs and external load balancer IPs. This guide covers the essential configuration, code patterns, and verification steps.
...
```yaml
# Configuration example for Cilium IPv6 Service Load Balancing
ipv6:
  enabled: true
  networks:
    - prefix: "2001:db8::/32"
