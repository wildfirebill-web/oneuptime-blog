# How to Roll Out ClusterIP Service Policies in Calico Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, ClusterIP, Security

Description: Roll Out Calico ClusterIP service policies to secure internal Kubernetes service-to-service communication.
...
This guide covers roll out ClusterIP Services policies in Calico with practical, production-tested configurations.
...
calicoctl apply -f roll-out-clusterip-services.yaml
