# How to Monitor Calico Pre-DNAT Policy Impact on Host Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Monitor Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers monitor pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
