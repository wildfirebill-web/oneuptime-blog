# How to Cilium eBPF IPv6 Networking Internals

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Cilium, eBPF, IPv6, Kubernetes, XDP, BPF Maps, Performance

Description: Understand how Cilium uses eBPF programs and BPF maps to implement high-performance IPv6 packet forwarding and policy enforcement.

## Introduction

Understand how Cilium uses eBPF programs and BPF maps to implement high-performance IPv6 packet forwarding and policy enforcement. This guide covers the essential configuration, code patterns, and verification steps.
...
```yaml
# Configuration example for Cilium eBPF IPv6 Networking Internals
ipv6:
  enabled: true
  networks:
    - prefix: "2001:db8::/32"
