# Common Mistakes to Avoid with Calico and Istio Application-Layer Policy

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Istio, Application Layer, Security

Description: Avoid Mistakes Calico application-layer network policies using Istio integration for HTTP method and path-based access control.
...
This guide covers avoid mistakes App-Layer Policy using Calico and Istio together.
...
kind: NetworkPolicy
metadata:
  name: avoid-mistakes-app-layer-policy
