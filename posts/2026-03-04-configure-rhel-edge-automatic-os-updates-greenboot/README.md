# How to Configure RHEL for Edge with Automatic OS Updates (Greenboot)

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: RHEL, Edge, Greenboot, Automatic Updates

Description: Configure RHEL for Edge with Greenboot for automatic OS updates with rollbacks.

---

## Overview

Configure RHEL for Edge with Greenboot for automatic OS updates with rollbacks. RHEL for Edge provides an immutable, atomic operating system designed for edge computing, IoT, and remote deployments.
...
You have learned how to configure rhel for edge with automatic os updates (greenboot). RHEL for Edge with rpm-ostree and MicroShift provides a robust platform for running workloads in remote and resource-constrained environments.
