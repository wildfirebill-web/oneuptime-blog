# How to Log and Audit ClusterIP Service Policies in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, ClusterIP, Security

Description: Log Audit Calico ClusterIP service policies to secure internal Kubernetes service-to-service communication.
...
calicoctl apply -f log-audit-clusterip-services.yaml
