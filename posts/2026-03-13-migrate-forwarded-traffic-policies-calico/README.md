# How to Migrate to Calico Forwarded Traffic Host Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Migrate Calico forwarded traffic policies on hosts for migrate traffic control at the node level.
...
metadata:
  name: migrate-forwarded-traffic
spec:
  order: 100
