# How to Set Up Cross-Site RHEL 9 Replication for Disaster Recovery

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: RHEL, Cross-Site Replication, Disaster Recovery, Linux

Description: Set up cross-site replication for RHEL 9 disaster recovery across data centers.

---

## Overview

Set up cross-site replication for RHEL 9 disaster recovery across data centers. A solid backup strategy protects against data loss from hardware failures, human errors, and security incidents.
...
You have learned how to set up cross-site rhel 9 replication for disaster recovery. Remember the 3-2-1 rule: keep three copies of your data, on two different media types, with one copy stored off-site.
