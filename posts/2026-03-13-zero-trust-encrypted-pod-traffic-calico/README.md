# Zero Trust Encrypted Pod Traffic with Calico WireGuard

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Encryption, WireGuard, Security

Description: Zero Trust Calico WireGuard encrypted pod traffic to ensure all inter-pod communication is encrypted in transit.
...
This guide covers zero trust WireGuard Encryption in Calico, including enabling WireGuard encryption and combining it with network policy for a complete zero-trust data plane.
...
kind: NetworkPolicy
metadata:
  name: zero-trust-wireguard-encryption
