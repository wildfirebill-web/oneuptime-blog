# How to Monitor Calico NodePort Traffic Policy Impact

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, NodePort, Security

Description: Monitor Calico NodePort traffic policies to secure Kubernetes NodePort service access.
...
This guide covers monitor NodePort Traffic policies in Calico with practical, production-tested configurations.
...
calicoctl apply -f monitor-nodeport-traffic.yaml
