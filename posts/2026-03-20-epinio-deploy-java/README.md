...
while true; do
  echo -e "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\nHello from How to Deploy a Java Application with Epinio!" | nc -l -p ${PORT:-8080}
done
EOF
chmod +x app.sh
```
