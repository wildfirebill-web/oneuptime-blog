# How to Configure IPv6 Prefix Delegation on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, IPv6, Prefix Delegation, DHCPv6-PD, RouterOS

Description: Configure DHCPv6 prefix delegation on MikroTik to receive a delegated IPv6 prefix from your ISP and distribute it to LAN interfaces.

## Overview

Configure DHCPv6 prefix delegation on MikroTik to receive a delegated IPv6 prefix from your ISP and distribute it to LAN interfaces.
...
How to Configure IPv6 Prefix Delegation on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
