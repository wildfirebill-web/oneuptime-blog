# How to Configure IPv6 Gateway Monitoring on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, Gateway Monitoring, High Availability, Failover

Description: Set up gateway monitoring for IPv6 default gateways in pfSense with quality thresholds and failover policies.

## Overview

Set up gateway monitoring for IPv6 default gateways in pfSense with quality thresholds and failover policies.
...
How to Configure IPv6 Gateway Monitoring on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
