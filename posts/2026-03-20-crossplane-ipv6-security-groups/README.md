# How to Configure Crossplane for IPv6 Security Groups
...
Define and provision cloud security groups with IPv6 ingress and egress rules using Crossplane composite resources.
