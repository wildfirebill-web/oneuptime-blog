# How to Scale Applications in Epinio

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Epinio, Scaling, Kubernetes, PaaS, High Availability

Description: Scale Epinio applications horizontally by adjusting replica counts for handling increased traffic.

## Introduction

How to Scale Applications in Epinio demonstrates how Epinio simplifies application deployment to Kubernetes. Epinio abstracts away Kubernetes complexity, letting developers focus on code while the platform handles containerization, deployment, and routing automatically.
