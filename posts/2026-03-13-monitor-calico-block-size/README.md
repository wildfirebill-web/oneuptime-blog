# How to Monitor Changing Calico Block Size

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Block Size, Networking

Description: Monitor Calico block allocation and IP utilization metrics to determine if block size adjustment is needed.
...
How to Monitor Changing Calico Block Size in Calico requires careful planning and validation. Use the steps above to ensure your configuration meets your cluster's IP addressing requirements.
