# How to Configure IPv6 Prefix Delegation on OPNsense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OPNsense, IPv6, Prefix Delegation, DHCPv6-PD, ISP

Description: Configure OPNsense to request and distribute DHCPv6 prefix delegation from an ISP for distributing IPv6 to LAN interfaces.

## Overview

Configure OPNsense to request and distribute DHCPv6 prefix delegation from an ISP for distributing IPv6 to LAN interfaces.
