# How to Roll Out HTTP Method Policies with Calico and Istio Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Istio, HTTP Methods, Security

Description: Roll Out Calico HTTP method-based network policies using Istio to control access by HTTP verb (GET, POST, DELETE, etc.).
...
This guide covers roll out HTTP Method Policies using Calico and Istio together.
...
kind: NetworkPolicy
metadata:
  name: roll-out-http-method-policies
