# Configuring Cilium Bandwidth Manager

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Cilium, Kubernetes, Networking

Description: Learn how to configure Cilium Bandwidth Manager for rate limiting pod traffic using eBPF-based traffic shaping in your Kubernetes cluster for optimal performance and security.
...
Apply the following Helm values to configure cilium bandwidth manager:
...
# Test workload to verify cilium bandwidth manager configuration
apiVersion: apps/v1
kind: Deployment
metadata:
  name: config-test
