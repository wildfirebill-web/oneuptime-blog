# How to Configure IPv6 WAN Interface on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, WAN, DHCPv6, SLAAC

Description: Configure the WAN interface on pfSense for various IPv6 connectivity types including SLAAC, DHCPv6, and static addressing.

## Overview

Configure the WAN interface on pfSense for various IPv6 connectivity types including SLAAC, DHCPv6, and static addressing.
...
How to Configure IPv6 WAN Interface on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
