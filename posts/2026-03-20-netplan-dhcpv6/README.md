# How to Configure DHCPv6 with Netplan

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Netplan, DHCPv6, IPv6, Ubuntu, Linux

Description: Configure Netplan to obtain an IPv6 address via DHCPv6 from a router or ISP on Ubuntu and Debian systems.

## Overview

Configure Netplan to obtain an IPv6 address via DHCPv6 from a router or ISP on Ubuntu and Debian systems.
