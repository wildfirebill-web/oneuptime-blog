# Securing Elasticsearch Integration in Cilium

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Cilium, Kubernetes, Network Security, Elasticsearch

Description: Learn how to secure Elasticsearch visibility in Cilium for Kubernetes. This guide covers practical hardening measures with real examples and commands.

---

## Introduction

Securing Elasticsearch visibility in Cilium is essential for maintaining a robust Kubernetes network security posture. Cilium leverages eBPF technology to provide deep visibility and control over network traffic, making it possible to enforce fine-grained security policies at the kernel level.

This guide focuses on practical steps to harden your Elasticsearch traffic policies using CiliumNetworkPolicy resources. You will learn how to create policies that restrict access, implement defense-in-depth strategies, and verify that your security controls are working as intended.
...
Before implementing security controls, it is important to understand how Cilium handles Elasticsearch visibility.
...
Apply a CiliumNetworkPolicy to restrict access to your elasticsearch integration resources.
...
kind: CiliumNetworkPolicy
metadata:
  name: default-deny-elasticsearch
