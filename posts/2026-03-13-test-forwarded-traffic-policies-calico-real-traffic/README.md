# How to Test Forwarded Traffic Policies for Calico Hosts with Real Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Test Calico forwarded traffic policies on hosts for test traffic control at the node level.
...
This guide covers how to test Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
