...
Set up zero-touch provisioning for edge devices running MicroShift on RHEL 9. RHEL for Edge provides an immutable, atomic operating system designed for edge computing, IoT, and remote deployments.
