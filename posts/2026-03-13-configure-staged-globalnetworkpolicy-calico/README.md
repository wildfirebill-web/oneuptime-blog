...
Staged GlobalNetworkPolicy is an advanced Calico feature that provides fine-grained network security controls using the `projectcalico.org/v3` API. This guide covers how to configure Staged GlobalNetworkPolicy effectively in your Kubernetes cluster.
...
calicoctl apply -f configure-staged-globalnetworkpolicy.yaml
