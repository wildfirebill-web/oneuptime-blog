...
For deploying Lambda functions to the edge specifically, see our guide on [deploying Lambda functions to edge with IoT Greengrass](https://oneuptime.com/blog/post/2026-02-12-deploy-lambda-functions-edge-iot-greengrass/view). For the IoT Core side of things, see our guide on [setting up AWS IoT Core for device connectivity](https://oneuptime.com/blog/post/2026-02-12-set-up-aws-iot-core-for-device-connectivity/view).
