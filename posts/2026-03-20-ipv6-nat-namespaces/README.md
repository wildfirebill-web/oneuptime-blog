...
Configure NAT66 (IPv6-to-IPv6 NAT) in Linux network namespaces for testing and specific deployment scenarios.
...
How to Configure IPv6 NAT with Network Namespaces uses standard Linux  commands with the  subcommand. All IPv6 configuration tools work identically inside namespaces. Network namespaces are an excellent, zero-cost way to test IPv6 configurations before deploying to production.
