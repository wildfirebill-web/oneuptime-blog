# How to Handle IPv6 in CORS Origin Headers

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: CORS, IPv6, Security, HTTP, Browser

Description: Configure CORS policies to allow requests from IPv6 origins including bracketed IPv6 addresses in Access-Control-Allow-Origin headers.

## Overview

Configure CORS policies to allow requests from IPv6 origins including bracketed IPv6 addresses in Access-Control-Allow-Origin headers.
...
How to Handle IPv6 in CORS Origin Headers requires understanding IPv6 address formats, normalizing IPv4-mapped addresses, and applying security policies at the /64 subnet level for IPv6 since individual users may have trillions of addresses within their prefix.
