# How to Configure DHCPv6 Server on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, DHCPv6, IPv6, Server, DHCP

Description: Enable and configure the DHCPv6 server in pfSense to assign IPv6 addresses to LAN clients statefully.

## Overview

Enable and configure the DHCPv6 server in pfSense to assign IPv6 addresses to LAN clients statefully.
...
How to Configure DHCPv6 Server on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
