# How to View Container Details and Inspect JSON in Portainer - View Details Json

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Portainer, Docker, Inspect, JSON, Debugging

Description: Access the full Docker inspect JSON output for containers in Portainer for advanced debugging and configuration review.
