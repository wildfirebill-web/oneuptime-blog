# How to Configure DHCPv6 Server on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, DHCPv6, IPv6, RouterOS, DHCP

Description: Set up a DHCPv6 server on MikroTik RouterOS to provide IPv6 addresses and DNS settings to LAN clients.

## Overview

Set up a DHCPv6 server on MikroTik RouterOS to provide IPv6 addresses and DNS settings to LAN clients.
...
How to Configure DHCPv6 Server on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
