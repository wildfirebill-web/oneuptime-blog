...
# Create your proposal from the template
cp template.md cfp-XXXX-your-feature.md
...
2. Escalate to SIG leads if unresolved
3. Bring to the community meeting for broader input
4. Maintainers make final decisions if consensus cannot be reached

### Participating in Elections

When governance positions are open:
- Eligibility is based on contribution history
- Nominations are posted publicly
- Voting follows documented procedures
- Results are announced in official channels
