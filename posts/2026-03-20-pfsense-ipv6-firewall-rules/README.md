# How to Configure IPv6 Firewall Rules on pfSense - Rules

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, Firewall Rules, Security, Networking

Description: Create IPv6 firewall rules in pfSense to control inbound and outbound IPv6 traffic with proper ICMPv6 handling.

## Overview

Create IPv6 firewall rules in pfSense to control inbound and outbound IPv6 traffic with proper ICMPv6 handling.
...
How to Configure IPv6 Firewall Rules on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
