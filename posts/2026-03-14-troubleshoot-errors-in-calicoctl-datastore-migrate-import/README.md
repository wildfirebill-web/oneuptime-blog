# Troubleshooting Errors in calicoctl datastore migrate import

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Calicoctl, Datastore Migration, Troubleshooting, Kubernetes

Description: Diagnose and resolve errors encountered during Calico datastore migration with calicoctl datastore migrate import.
