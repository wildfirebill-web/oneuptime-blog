# How to Deploy RHEL for Edge with rpm-ostree on IoT Devices
...
Deploy RHEL for Edge with rpm-ostree on IoT devices for immutable updates. RHEL for Edge provides an immutable, atomic operating system designed for edge computing, IoT, and remote deployments.
...
You have learned how to deploy rhel for edge with rpm-ostree on iot devices. RHEL for Edge with rpm-ostree and MicroShift provides a robust platform for running workloads in remote and resource-constrained environments.
