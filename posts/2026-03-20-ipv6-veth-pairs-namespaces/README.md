...
How to Connect Network Namespaces with IPv6 veth Pairs uses standard Linux  commands with the  subcommand. All IPv6 configuration tools work identically inside namespaces. Network namespaces are an excellent, zero-cost way to test IPv6 configurations before deploying to production.
