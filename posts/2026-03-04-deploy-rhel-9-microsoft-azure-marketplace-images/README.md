# How to Deploy RHEL 9 on Microsoft Azure with Marketplace Images

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: RHEL, Azure, Marketplace, Cloud

Description: Deploy RHEL 9 on Microsoft Azure using Marketplace images.

---

## Overview

Deploy RHEL 9 on Microsoft Azure using Marketplace images. RHEL 9 is fully supported on major cloud platforms with official images and integrated tooling.
...
You have learned how to deploy rhel 9 on microsoft azure with marketplace images. RHEL 9 on cloud platforms benefits from official support, pre-configured images, and integration with Red Hat management tools.
