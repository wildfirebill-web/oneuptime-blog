# How to Enable IPv6 on OPNsense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OPNsense, IPv6, Firewall, Configuration, Networking

Description: Enable IPv6 support on OPNsense firewall with global settings, interface tracking, and dual-stack operation.

## Overview

Enable IPv6 support on OPNsense firewall with global settings, interface tracking, and dual-stack operation.
...
How to Enable IPv6 on OPNsense uses OPNsense's web interface which mirrors pfSense's structure but with a cleaner UI. Always configure ICMPv6 passthrough rules in the firewall, use interface tracking for LAN to automatically use the delegated prefix, and verify with the built-in ping diagnostic tool.
