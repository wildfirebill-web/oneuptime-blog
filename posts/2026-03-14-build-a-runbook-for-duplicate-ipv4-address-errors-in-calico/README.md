# Building a Runbook for Duplicate IPv4 Address Errors in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Troubleshooting, Runbook

Description: A structured operational runbook for on-call engineers to follow when Duplicate IPv4 Address errors occur in Kubernetes clusters running Calico.
...
A runbook transforms tribal knowledge into a repeatable procedure that any on-call engineer can follow. This guide provides a structured runbook for handling Duplicate IPv4 Address errors, designed to minimize mean time to resolution (MTTR).
...
## Runbook: Duplicate IPv4 Address Error Response
