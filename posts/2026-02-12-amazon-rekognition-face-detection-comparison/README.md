...
For monitoring the health of your Rekognition-powered applications, including API latency, error rates, and throughput, check out our guide on [monitoring AWS infrastructure](https://oneuptime.com/blog/post/2026-02-02-pulumi-aws-infrastructure/view). For training custom visual models, see our post on [Rekognition Custom Labels](https://oneuptime.com/blog/post/2026-02-12-amazon-rekognition-custom-labels/view).
