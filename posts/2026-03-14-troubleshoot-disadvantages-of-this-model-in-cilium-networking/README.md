# Troubleshooting Disadvantages of Native Routing in Cilium
...
Examine the Cilium data path for issues related to disadvantages of native routing in cilium:
