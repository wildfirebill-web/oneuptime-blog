# How to Enable IPv6 Package on MikroTik RouterOS

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, IPv6, RouterOS, Configuration, Networking

Description: Enable the IPv6 package on MikroTik RouterOS devices and verify IPv6 support is active for configuration.

## Overview

Enable the IPv6 package on MikroTik RouterOS devices and verify IPv6 support is active for configuration.
...
How to Enable IPv6 Package on MikroTik RouterOS on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
