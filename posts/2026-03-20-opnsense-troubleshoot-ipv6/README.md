# How to Troubleshoot IPv6 on OPNsense
...
Diagnose and fix IPv6 connectivity problems on OPNsense using built-in diagnostics, packet capture, and log analysis.
