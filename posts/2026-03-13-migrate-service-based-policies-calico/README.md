# How to Migrate to Service-Based Policies in Calico
...
Migrating from pod-selector policies to service-based policies involves identifying which policies are protecting service endpoints and rewriting them to reference the Service object directly for better stability and readability.
...
This guide covers practical techniques for migrate to service-based Calico policies effectively.
