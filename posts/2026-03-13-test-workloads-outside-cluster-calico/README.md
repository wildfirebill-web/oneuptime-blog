# How to Test Workloads Outside the Cluster with Calico with Live Workloads

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, BGP, External Workloads, Networking

Description: Test connectivity between Calico-managed Kubernetes pods and external workloads under realistic traffic conditions.
