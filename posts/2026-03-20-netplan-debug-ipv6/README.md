# How to Debug Netplan IPv6 Configuration Issues

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Netplan, IPv6, Debugging, Ubuntu, systemd-networkd

Description: Diagnose Netplan IPv6 configuration problems using netplan try, systemd-networkd logs, and ip command output.

## Overview

Diagnose Netplan IPv6 configuration problems using netplan try, systemd-networkd logs, and ip command output.
