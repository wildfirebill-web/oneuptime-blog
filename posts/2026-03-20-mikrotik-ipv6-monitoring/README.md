# How to Monitor IPv6 Traffic on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, IPv6, Monitoring, Torch, RouterOS

Description: Monitor IPv6 traffic, connection tracking, and interface statistics on MikroTik RouterOS using Torch, Graphing, and SNMP.

## Overview

Monitor IPv6 traffic, connection tracking, and interface statistics on MikroTik RouterOS using Torch, Graphing, and SNMP.
...
How to Monitor IPv6 Traffic on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
