# How to Roll Out Pre-DNAT Policies for Calico Host Traffic Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Roll Out Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers roll out pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
