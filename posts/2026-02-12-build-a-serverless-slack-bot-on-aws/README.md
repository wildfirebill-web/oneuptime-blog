...
For integrating your Slack bot with approval workflows, check out our guide on [building human approval workflows with Step Functions](https://oneuptime.com/blog/post/2026-02-12-build-human-approval-workflows-with-step-functions/view). For building scheduled bot messages, see [building serverless cron jobs with EventBridge and Lambda](https://oneuptime.com/blog/post/2026-02-12-build-a-serverless-cron-job-with-eventbridge-and-lambda/view).
