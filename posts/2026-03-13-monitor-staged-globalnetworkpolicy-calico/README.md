# How to Monitor Staged GlobalNetworkPolicy in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Staged Policies, Global Policy

Description: Monitor the impact of Staged GlobalNetworkPolicy in Calico using metrics and dashboards.

---

## Introduction

Staged GlobalNetworkPolicy is an advanced Calico feature that provides fine-grained network security controls using the `projectcalico.org/v3` API. This guide covers how to monitor Staged GlobalNetworkPolicy effectively in your Kubernetes cluster.
...
This guide provides production-tested patterns for monitor Staged GlobalNetworkPolicy, including YAML examples, CLI commands, and troubleshooting techniques.
...
kind: NetworkPolicy
metadata:
  name: monitor-staged-globalnetworkpolicy
...
calicoctl apply -f monitor-staged-globalnetworkpolicy.yaml
