...
How to Use Container Images with Epinio demonstrates how Epinio simplifies application deployment to Kubernetes. Epinio abstracts away Kubernetes complexity, letting developers focus on code while the platform handles containerization, deployment, and routing automatically.
...
while true; do
  echo -e "HTTP/1.1 200 OK\r\nContent-Type: text/plain\r\n\r\nHello from How to Use Container Images with Epinio!" | nc -l -p ${PORT:-8080}
done
EOF
chmod +x app.sh
```
