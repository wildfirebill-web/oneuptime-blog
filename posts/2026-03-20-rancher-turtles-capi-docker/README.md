...
Rancher Turtles integrates Cluster API (CAPI) with Rancher to provide a unified, declarative approach to Kubernetes cluster lifecycle management. This guide walks through the specifics of How to Use CAPI with Docker Provider for Testing.
...
```yaml
# Example CAPI configuration for How to Use CAPI with Docker Provider for Testing
