# How to Optimize IP Address Allocation by Topology in Calico for Large Clusters

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Topology, Networking

Description: Optimize topology-aware Calico IPAM for large multi-zone clusters to minimize cross-zone routing.
