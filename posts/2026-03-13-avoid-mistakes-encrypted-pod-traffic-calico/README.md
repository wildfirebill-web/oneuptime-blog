# Common Mistakes to Avoid with Calico Encrypted Pod Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Encryption, WireGuard, Security

Description: Avoid Mistakes Calico WireGuard encrypted pod traffic to ensure all inter-pod communication is encrypted in transit.
...
This guide covers avoid mistakes WireGuard Encryption in Calico, including enabling WireGuard encryption and combining it with network policy for a complete zero-trust data plane.
...
kind: NetworkPolicy
metadata:
  name: avoid-mistakes-wireguard-encryption
