# How to Monitor Forwarded Traffic Policies on Calico Hosts

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Monitor Calico forwarded traffic policies on hosts for monitor traffic control at the node level.
...
This guide covers how to monitor Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: monitor-forwarded-traffic
spec:
  order: 100
