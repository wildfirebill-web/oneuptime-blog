...
Unit tests for CDK stacks are fast, deterministic, and catch a surprising number of real issues. They're especially valuable when you're building [custom CDK constructs](https://oneuptime.com/blog/post/2026-02-12-create-custom-cdk-constructs/view) that other teams will use. For testing the actual deployed behavior, see the guide on [integration tests for CDK stacks](https://oneuptime.com/blog/post/2026-02-12-write-integration-tests-for-cdk-stacks/view). And for catching template regressions, check out [snapshot tests for CDK stacks](https://oneuptime.com/blog/post/2026-02-12-write-snapshot-tests-for-cdk-stacks/view).
