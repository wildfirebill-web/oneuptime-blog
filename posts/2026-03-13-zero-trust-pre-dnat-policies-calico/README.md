# Zero Trust with Pre-DNAT Policies for Calico Host Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Zero Trust Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers zero trust pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
...
metadata:
  name: zero-trust-pre-dnat-policy
spec:
  order: 100
  preDNAT: true
  applyOnForward: true
