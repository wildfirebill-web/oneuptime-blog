# How to Set Up OpenTofu Documentation with terraform-docs

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OpenTofu, terraform-docs, Documentation, Infrastructure as Code, IaC, Developer Experience

Description: Learn how to use terraform-docs to generate and maintain consistent documentation for OpenTofu modules.
