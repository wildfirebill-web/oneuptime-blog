# Validating Egress in Cilium Networking
...
# Test deployment for egress in cilium networking validation
apiVersion: apps/v1
kind: Deployment
metadata:
...
Confirm metrics are being collected for egress in cilium networking:
...
```bash
echo "=== Egress in Cilium Networking Validation Summary ==="

# 1. Configuration correct
echo "1. Configuration:"
cilium config view | grep -i egress 2>/dev/null | head -5
