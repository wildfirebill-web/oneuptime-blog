# Monitoring for Duplicate IPv4 Address Errors in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Troubleshooting, Monitoring

Description: Set up alerting and observability to detect Duplicate IPv4 Address errors early in Kubernetes clusters running Calico.
...
Detecting Duplicate IPv4 Address errors before they impact users requires proper monitoring and alerting. This guide shows you how to set up observability for the Calico components relevant to this error class.

Early detection dramatically reduces mean time to resolution (MTTR). A well-configured monitoring stack can alert you to conditions that lead to Duplicate IPv4 Address errors before they cause pod connectivity failures.
...
Create PrometheusRule resources for Duplicate IPv4 Address-related conditions:
...
Monitoring for Duplicate IPv4 Address errors requires a combination of Prometheus metrics from Calico components and log-based alerting. Set conservative alert thresholds initially and tune them based on your cluster's normal behavior patterns.
