# How to Configure IPv6 LAN Interface on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, LAN, Interface, Networking

Description: Set up the LAN interface on pfSense with an IPv6 subnet for distributing connectivity to internal hosts.

## Overview

Set up the LAN interface on pfSense with an IPv6 subnet for distributing connectivity to internal hosts.
...
How to Configure IPv6 LAN Interface on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
