...
- [What are metrics in OpenTelemetry: A Complete Guide](https://oneuptime.com/blog/post/2025-08-26-what-are-metrics-in-opentelemetry/view) -  Understand the quantitative side (counts, rates, percentiles) to pair with your tracing data.
- [How to name spans in OpenTelemetry](https://oneuptime.com/blog/post/2024-11-04-how-to-name-spans-in-opentelemetry/view) -  Apply consistent naming so traces remain searchable and comparable over time.
