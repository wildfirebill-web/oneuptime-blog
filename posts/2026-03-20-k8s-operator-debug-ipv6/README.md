# How to Debug Operator IPv6 Connectivity Issues
...
Debug network connectivity issues in Kubernetes operators related to IPv6, including pod-to-pod communication and external service access.
...
How to Debug Operator IPv6 Connectivity Issues involves using Go's `net` package for IPv6 validation, handling dual-stack service creation with `IPFamilyPolicy`, and testing against IPv6-enabled Kubernetes clusters. Always validate IPv6 addresses in CRD webhook validators to catch issues before reconciliation.
