# How to Configure WebSocket Load Balancing with IPv6

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: WebSocket, IPv6, Load Balancing, Nginx, HAProxy

Description: Configure Nginx and HAProxy to load balance WebSocket connections over IPv6 with sticky sessions and connection persistence.

## Overview

Configure Nginx and HAProxy to load balance WebSocket connections over IPv6 with sticky sessions and connection persistence. This guide covers the essential configuration and best practices for IPv6 compatibility.
...
How to Configure WebSocket Load Balancing with IPv6 requires binding to IPv6 interfaces, configuring firewalls, and using correct IPv6 URL format for clients. Test thoroughly with wscat and automate IPv6-specific connectivity tests in your CI/CD pipeline.
