# How to Test IP Address Allocation by Topology in Calico Before Production

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, IPAM, Topology, Networking

Description: Test Calico topology-aware IPAM to verify pod IPs are allocated from the correct topology zone.
