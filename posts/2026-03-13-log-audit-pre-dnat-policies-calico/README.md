# How to Log and Audit Pre-DNAT Policies for Calico Host Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Log Audit Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers log audit pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
...
metadata:
  name: log-audit-pre-dnat-policy
spec:
  order: 100
  preDNAT: true
  applyOnForward: true
