# How to Migrate to Kubernetes NetworkPolicy Basics with Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Basics, Security

Description: Migrate Kubernetes NetworkPolicy basics using Calico as the network policy enforcement engine.
