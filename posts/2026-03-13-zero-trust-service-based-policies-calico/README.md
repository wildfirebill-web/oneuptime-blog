# How to Zero Trust with Service-Based Policies in Calico
...
Zero trust service policies ensure that every service can only be called by explicitly authorized workloads. By targeting Kubernetes Services in your Calico egress policies, you control exactly which services each workload can call.
...
This guide covers practical techniques for zero trust with service-based Calico policies effectively.
