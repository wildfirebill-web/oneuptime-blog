# How to Configure Pre-DNAT Policies for Calico Host Traffic

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Configure Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers configure pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
...
metadata:
  name: configure-pre-dnat-policy
spec:
  order: 100
  preDNAT: true
  applyOnForward: true
