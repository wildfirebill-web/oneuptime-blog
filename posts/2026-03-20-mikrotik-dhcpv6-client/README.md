# How to Configure DHCPv6 Client on MikroTik

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: MikroTik, DHCPv6, Client, IPv6, RouterOS

Description: Configure MikroTik RouterOS as a DHCPv6 client to obtain an IPv6 address from an upstream provider.

## Overview

Configure MikroTik RouterOS as a DHCPv6 client to obtain an IPv6 address from an upstream provider.
...
How to Configure DHCPv6 Client on MikroTik on MikroTik RouterOS uses the `/ipv6` command tree. Remember that ICMPv6 must always be allowed in the firewall for IPv6 to function correctly. Use `/ipv6 address print` and `/ipv6 route print` to verify your configuration.
