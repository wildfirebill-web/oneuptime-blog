# Zero Trust with Kubernetes NetworkPolicy Basics Enforced by Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Basics, Security

Description: Zero Trust Kubernetes NetworkPolicy basics using Calico as the network policy enforcement engine.
