# Monitoring Disadvantages of Native Routing in Cilium
...
This guide covers metrics collection, dashboard creation, and alert configuration for disadvantages of native routing in cilium.
...
## Key Metrics for Disadvantages of Native Routing in Cilium
...
Create Prometheus alerts for disadvantages of native routing in cilium:

```yaml
# cilium-feature-alerts.yaml
# Alerting rules for disadvantages of native routing in cilium
      ...
      rules:
        - alert: CiliumAgentUnhealthy
          ...
          annotations:
            ...
            description: "{{ $value }} Cilium agent pods are not running, affecting disadvantages of native routing in cilium."
...
Create a Grafana dashboard for disadvantages of native routing in cilium:
