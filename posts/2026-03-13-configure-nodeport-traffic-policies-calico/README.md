# How to Configure NodePort Traffic Policies in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, NodePort, Security

Description: Configure Calico NodePort traffic policies to secure Kubernetes NodePort service access.
...
This guide covers configure NodePort Traffic policies in Calico with practical, production-tested configurations.
...
calicoctl apply -f configure-nodeport-traffic.yaml
