# How to Apply and Test Netplan IPv6 Changes Safely

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Netplan, IPv6, Testing, Ubuntu, Safe Deployment

Description: Safely apply and test Netplan IPv6 configuration changes using netplan try for automatic rollback on failure.

## Overview

Safely apply and test Netplan IPv6 configuration changes using netplan try for automatic rollback on failure.
