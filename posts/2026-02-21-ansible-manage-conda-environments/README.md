# How to Use Ansible to Manage Conda Environments

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Ansible, Python, Conda, Data Science

Description: Automate Conda environment creation and package management on remote hosts using Ansible for data science and ML infrastructure.
...
```yaml
---
- name: How to Use Ansible to Manage Conda Environments
  hosts: app_servers
  become: true
