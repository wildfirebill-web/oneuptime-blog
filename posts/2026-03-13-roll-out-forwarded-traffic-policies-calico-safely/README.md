# How to Roll Out Forwarded Traffic Policies for Calico Hosts Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Roll Out Calico forwarded traffic policies on hosts for roll out traffic control at the node level.
...
This guide covers how to roll out Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: roll-out-forwarded-traffic
spec:
  order: 100
