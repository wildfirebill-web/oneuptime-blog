# How to Validate Kubernetes NetworkPolicy Basics with Calico Before Production

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Basics, Security

Description: Validate Kubernetes NetworkPolicy basics using Calico as the network policy enforcement engine.
