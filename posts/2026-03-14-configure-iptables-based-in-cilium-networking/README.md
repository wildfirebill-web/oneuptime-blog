# Configuring iptables-Based Masquerading in Cilium

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Cilium, Kubernetes, Networking

Description: Learn how to configure iptables-based masquerading mode in Cilium networking as an alternative to eBPF-based masquerading in your Kubernetes cluster for optimal performance and security.
...
Apply the following Helm values to configure iptables-based masquerading in cilium:
...
# Test workload to verify iptables-based masquerading in cilium configuration
apiVersion: apps/v1
kind: Deployment
metadata:
  name: config-test
