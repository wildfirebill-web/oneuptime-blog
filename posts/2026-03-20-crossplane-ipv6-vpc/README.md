# How to Configure Crossplane for IPv6 VPC Provisioning

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Crossplane, IPv6, VPC, AWS, Infrastructure as Code

Description: Use Crossplane AWS or GCP providers to provision VPCs with IPv6 CIDR blocks enabled through GitOps-style infrastructure management.

## Overview

Use Crossplane AWS or GCP providers to provision VPCs with IPv6 CIDR blocks enabled through GitOps-style infrastructure management.
