# How to Troubleshoot IPv6 on OpenWrt

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OpenWrt, IPv6, Troubleshooting, Debugging, Odhcp6c

Description: Diagnose and fix common IPv6 problems on OpenWrt including PD failures, RA issues, and connectivity debugging.

## Overview

Diagnose and fix common IPv6 problems on OpenWrt including PD failures, RA issues, and connectivity debugging.
...
How to Troubleshoot IPv6 on OpenWrt primarily involves UCI configuration files at `/etc/config/network` and `/etc/config/dhcp`. The key components are odhcp6c (WAN DHCPv6 client) and odhcpd (LAN DHCPv6 server + RA). Always check logs with `logread` when troubleshooting IPv6 issues.
