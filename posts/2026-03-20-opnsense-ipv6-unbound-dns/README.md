# How to Configure IPv6 with Unbound DNS on OPNsense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OPNsense, IPv6, Unbound, DNS, AAAA

Description: Configure Unbound DNS resolver on OPNsense to resolve AAAA records over IPv6 and serve DNS to IPv6 clients.

## Overview

Configure Unbound DNS resolver on OPNsense to resolve AAAA records over IPv6 and serve DNS to IPv6 clients.
