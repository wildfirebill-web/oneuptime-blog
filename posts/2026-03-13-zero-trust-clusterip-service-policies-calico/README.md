# Zero Trust ClusterIP Service Security with Calico Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, ClusterIP, Security

Description: Zero Trust Calico ClusterIP service policies to secure internal Kubernetes service-to-service communication.
...
calicoctl apply -f zero-trust-clusterip-services.yaml
