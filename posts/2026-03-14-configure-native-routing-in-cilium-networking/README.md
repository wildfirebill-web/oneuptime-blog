...
Apply the following Helm values to configure native routing in cilium:
...
# Specify the pod CIDR that is natively routable
ipv4NativeRoutingCIDR: "10.42.0.0/16"

# Automatically add routes to other nodes
autoDirectNodeRoutes: true

# Enable masquerading for traffic leaving the cluster
...
# Test workload to verify native routing in cilium configuration
apiVersion: apps/v1
kind: Deployment
metadata:
  name: config-test
