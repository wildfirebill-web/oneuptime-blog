# How to Troubleshoot Workloads Outside the Cluster with Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, BGP, External Workloads, Networking

Description: Diagnose connectivity failures between Kubernetes pods and external workloads in Calico environments.
