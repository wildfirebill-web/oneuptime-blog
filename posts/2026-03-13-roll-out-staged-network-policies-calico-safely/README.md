# How to Roll Out Staged Network Policies in Calico Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Staged Policies, Security

Description: A phased rollout strategy for Staged Network Policies in Calico that prevents outages.

---

## Introduction

Staged Network Policies is an advanced Calico feature that provides fine-grained network security controls using the `projectcalico.org/v3` API. This guide covers how to roll out Staged Policies effectively in your Kubernetes cluster.
...
This guide provides production-tested patterns for roll out Staged Policies, including YAML examples, CLI commands, and troubleshooting techniques.
...
Roll Out Staged Policies in Calico requires careful attention to policy ordering, selector syntax, and bidirectional traffic rules. Use the patterns in this guide as a starting point, adapt them to your specific requirements, and always validate changes in a staging environment before applying to production. Consistent logging and monitoring will help you detect and resolve issues quickly when they occur.
