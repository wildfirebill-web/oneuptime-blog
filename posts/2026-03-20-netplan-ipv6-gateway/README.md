# How to Configure IPv6 Gateway with Netplan

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Netplan, IPv6, Gateway, Routing, Ubuntu

Description: Set a default IPv6 gateway and per-route IPv6 next-hops in Netplan YAML configuration for proper IPv6 routing.

## Overview

Set a default IPv6 gateway and per-route IPv6 next-hops in Netplan YAML configuration for proper IPv6 routing.
