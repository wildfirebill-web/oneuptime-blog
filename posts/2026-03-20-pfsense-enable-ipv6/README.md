# How to Enable IPv6 on pfSense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: pfSense, IPv6, Firewall, Networking, Configuration

Description: Enable IPv6 support on pfSense firewall and configure global IPv6 settings for dual-stack network operation.

## Overview

Enable IPv6 support on pfSense firewall and configure global IPv6 settings for dual-stack network operation.
...
How to Enable IPv6 on pfSense primarily uses the pfSense WebGUI under the Interfaces and Services menus. Always allow ICMPv6 in firewall rules as it is required for IPv6 operation. Use the built-in Diagnostics tools for quick troubleshooting before diving into packet captures.
