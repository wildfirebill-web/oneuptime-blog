# How to Configure Container Cgroup Limits in Portainer - A Practical Guide

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: Portainer, Docker, Cgroups, Resource Limits, Performance

Description: Configure Linux cgroup resource limits for containers in Portainer to control CPU, memory, and I/O allocation.

## Introduction

Configure Linux cgroup resource limits for containers in Portainer to control CPU, memory, and I/O allocation. This guide walks you through the process step by step with practical examples.
...
Understanding how to Configure Container Cgroup Limits in Portainer gives you greater control over your containerized infrastructure. Portainer's visual interface makes these operations accessible to team members who may not be comfortable with the Docker CLI, while also providing quick access to underlying Docker capabilities. Regular use of these features helps maintain healthy, well-monitored container environments.
