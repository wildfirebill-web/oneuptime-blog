# How to Configure IPv6 VPN on OPNsense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OPNsense, IPv6, VPN, WireGuard, OpenVPN

Description: Configure WireGuard and OpenVPN on OPNsense to support IPv6 traffic through encrypted VPN tunnels.

## Overview

Configure WireGuard and OpenVPN on OPNsense to support IPv6 traffic through encrypted VPN tunnels.
