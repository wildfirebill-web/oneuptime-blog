# How to Migrate to Encrypted Pod Traffic in Calico
...
This guide covers migrate WireGuard Encryption in Calico, including enabling WireGuard encryption and combining it with network policy for a complete zero-trust data plane.
...
kind: NetworkPolicy
metadata:
  name: migrate-wireguard-encryption
