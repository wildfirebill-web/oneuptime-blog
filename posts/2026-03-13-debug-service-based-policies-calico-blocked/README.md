# How to Debug Service-Based Policies in Calico
...
Service-based Calico policy failures often occur because the service name is wrong, the service is in the wrong namespace, or the service's backing pods don't have the labels expected by the policy. The traffic failure gives you no indication of which part is wrong.
...
This guide covers practical techniques for debug service-based Calico policies effectively.
