# How to Configure IPv6 LAN Interface on OPNsense

Author: [nawazdhandala](https://www.github.com/nawazdhandala)

Tags: OPNsense, IPv6, LAN, Interface, Networking

Description: Set up IPv6 on the LAN interface of OPNsense using interface tracking or static addressing for internal hosts.

## Overview

Set up IPv6 on the LAN interface of OPNsense using interface tracking or static addressing for internal hosts.
