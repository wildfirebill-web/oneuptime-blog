# How to Migrate to Calico Host Endpoint Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Endpoint, Security

Description: Migrate existing host firewall rules to Calico host endpoint policies for unified management.
...
This guide covers how to migrate Host Endpoints effectively, with production-ready YAML configurations and operational commands.
