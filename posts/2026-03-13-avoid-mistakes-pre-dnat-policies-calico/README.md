# Common Mistakes to Avoid with Calico Pre-DNAT Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Pre-DNAT, Host Traffic, Security

Description: Avoid Mistakes Calico pre-DNAT policies for host traffic control before destination address translation.
...
This guide covers avoid mistakes pre-DNAT policies in Calico for controlling external access to NodePort and LoadBalancer services.
...
metadata:
  name: avoid-mistakes-pre-dnat-policy
spec:
  order: 100
  preDNAT: true
  applyOnForward: true
