# How to Avoid Mistakes with Service-Based Policies in Calico

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Services, Best Practice
...
Service-based Calico policies have unique failure modes: referencing non-existent services, wrong service namespaces, and policies that target pod labels instead of service references are the most common mistakes.
...
This guide covers practical techniques for avoid mistakes with service-based Calico policies effectively.
