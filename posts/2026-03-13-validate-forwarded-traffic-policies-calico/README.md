# How to Validate Calico Forwarded Traffic Policies Before Production

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Validate Calico forwarded traffic policies on hosts for validate traffic control at the node level.
...
This guide covers how to validate Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: validate-forwarded-traffic
spec:
  order: 100
