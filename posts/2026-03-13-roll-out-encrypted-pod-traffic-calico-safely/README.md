# How to Roll Out Encrypted Pod Traffic in Calico Safely

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Encryption, WireGuard, Security

Description: Roll Out Calico WireGuard encrypted pod traffic to ensure all inter-pod communication is encrypted in transit.
...
This guide covers roll out WireGuard Encryption in Calico, including enabling WireGuard encryption and combining it with network policy for a complete zero-trust data plane.
...
kind: NetworkPolicy
metadata:
  name: roll-out-wireguard-encryption
