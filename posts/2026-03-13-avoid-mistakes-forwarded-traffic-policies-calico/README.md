# Common Mistakes to Avoid with Calico Forwarded Traffic Policies

Author: [nawazdhandala](https://github.com/nawazdhandala)

Tags: Calico, Kubernetes, Network Policy, Host Traffic, Forwarding, Security

Description: Avoid Mistakes Calico forwarded traffic policies on hosts for avoid mistakes traffic control at the node level.
...
This guide covers how to avoid mistakes Forwarded Traffic effectively, with production-ready YAML configurations and operational commands.
...
metadata:
  name: avoid-mistakes-forwarded-traffic
spec:
  order: 100
